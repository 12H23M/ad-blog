...
![OWL 대시보드 — 수익 현황 +$211, 50건 거래](/images/owl-ratchet-dashboard.png)
*대시보드 전체 현황. +$211 누적 수익. FGI 12 극공포에서도 래칫이 수익을 보호하고 있다.*
...
![봇 모니터링 — 30개 봇 상태 한 눈에](/images/owl-ratchet-bots.jpg)
*봇 모니터링 화면. 포지션 보유 중인 봇은 TP/SL이 실시간으로 래칫 업데이트된다.*
